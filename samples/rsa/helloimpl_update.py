...
class RemoteHelloConsumer(object):
    ...
    def _validate(self,bundle_context):
        # first register
        registration = bundle_context.register_service("org.eclipse.ecf.examples.hello.IHello", 
                                                       HelloImpl(), 
        ...
        # this will trigger an export update, publish the update via discovery (if any)
        # which will propagate to import side
