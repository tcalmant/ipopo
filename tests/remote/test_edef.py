...
class EdefIOTest(unittest.TestCase):
    ...
    def testEdefRefusesEntities(self) -> None:
        """
        EDEF documents are read from the network (MQTT, Redis, ZooKeeper):
        they must not be able to declare entities, as their expansion can
        exhaust the memory of the framework
        """
 ...
 <!ENTITY lol3 "&lol2;&lol2;&lol2;&lol2;&lol2;&lol2;&lol2;&lol2;&lol2;&lol2;">
        ...
        for document in (billion_laughs, external_entity):
            with self.subTest(document=document[:40]):
                # Given as a string and as bytes (MQTT payloads are bytes)
